...
def generate_doc():
    try:
        ...
        image_file = request.files.get(
            "image"
        )  # 'image' is the name of the file input in the frontend
        if image_file:
        ...
        if (
            "damageScenariosTable" in request.form
            and int(request.form["damageScenariosTable"]) == 1
        ):
            damage_scenarios_table = 1
        else:
            damage_scenarios_table = 0
        if (
            "threatScenariosTable" in request.form
            and int(request.form["threatScenariosTable"]) == 1
        ):
        ...
        if (
            "attackTreatScenariosTable" in request.form
            and int(request.form["attackTreatScenariosTable"]) == 1
        ):
        ...
        if (
            "riskTreatmentTable" in request.form
            and int(request.form["riskTreatmentTable"]) == 1
        ):
            risk_treatment = 1
        else:
            risk_treatment = 0
                    ...
                    TableStyle(
                        [
                            (
                                ...
                                (0, 0),
                                (-1, -1),
                                colors.toColor(bg_color),
                            ),  # Background for the whole cell
                            (
                                "TEXTCOLOR",
                                (0, 0),
                                (-1, -1),
                                colors.toColor(text_color),
                            ),  # Text color
                            (
                                "ALIGN",
                                (0, 0),
                            ...
                            (
                                ...
                                (-1, -1),
                                5,
                            ),  # Optional: Add padding to make it more spacious
                            (
                                "TOPPADDING",
                                (0, 0),
                                (-1, -1),
        ...
        if damage_scenarios_table == 1:
            damage_record = db.Damage_scenarios.find_one(
            ...
            valid_columns = [
                ...
                "Losses of Cybersecurity Properties",
                "Assets",
                "Component/Message",
                "Safety Impact",
                "Financial Impact",
                ...
                if damage_record:
                    ...
                    for col in dmg_columns:
                        if col == "ID":
                            ...
                            damage_headers.append(
                                wrap_content("Damage Scenario", "white")
                            )
                        elif col == "Description/Scalability":
                            damage_headers.append(
                                wrap_content("Description/Scalability", "white")
                            )
                        elif col == "Losses of Cybersecurity Properties":
                            damage_headers.append(
                                wrap_content(
                                    "Losses of Cybersecurity Properties", "white"
                                )
                            )
                        elif col == "Assets":
                            ...
                            damage_headers.append(
                                wrap_content("Component/Message", "white")
                            )
                        elif col == "Safety Impact":
                            damage_headers.append(
                                wrap_content("Safety Impact", "white")
                            )
                        elif col == "Financial Impact":
                            damage_headers.append(
                                wrap_content("Financial Impact", "white")
                            )
                        elif col == "Operational Impact":
                            damage_headers.append(
                                wrap_content("Operational Impact", "white")
                            )
                        elif col == "Privacy Impact":
                            damage_headers.append(
                                wrap_content("Privacy Impact", "white")
                            )
                        elif col == "Impact Justification":
                            damage_headers.append(
                                wrap_content("Impact Justification", "white")
                            )
                        elif col == "Associated Threat Scenarios":
                            damage_headers.append(
                                wrap_content("Associated Threat Scenarios", "white")
                            )
                        elif col == "Overall Impact":
                            damage_headers.append(
                                wrap_content("Overall Impact", "white")
                            )
                        elif col == "Asset is Evaluated":
                            damage_headers.append(
                                wrap_content("Asset is Evaluated", "white")
                            )
                        elif col == "Cybersecurity Properties are Evaluated":
                            damage_headers.append(
                                wrap_content(
                                    "Cybersecurity Properties are Evaluated", "white"
                                )
                            )
                        elif col == "Unevaluated Cybersecurity Properties":
                            damage_headers.append(
                                wrap_content(
                                    "Unevaluated Cybersecurity Properties", "white"
                                )
                            )
                    ...
                    for index, detail in enumerate(damage_details):
                        ...
                        assets = "\n".join(
                            [loss["node"] for loss in detail.get("cyberLosses", [])]
                        )
                        ...
                        for col in dmg_columns:
                            if col == "ID":
                                row.append(
                                    wrap_content(f"DS{index + 1:03}", "black")
                                )  # Auto-generated ID
                            elif col == "Name":
                                row.append(
                                    wrap_content(detail.get("Name", ""), "black")
                                )  # Name
                            elif col == "Damage Scenario":
                                row.append(wrap_content(""))
                            elif col == "Description/Scalability":
                                row.append(
                                    wrap_content(detail.get("Description", ""), "black")
                                )  # Description
                            elif col == "Losses of Cybersecurity Properties":
                                row.append(
                                    cyber_losses
                                ...
                                row.append(
                                    wrap_content(overall_impact, "black", bg_color)
                                )  # Overall Impact
                            elif col == "Asset is Evaluated":
                                row.append(wrap_content(""))
                            elif col == "Cybersecurity Properties are Evaluated":
        ...
        if threat_scenarios_table == 1:
            threat_record = db.Threat_scenarios.find_one(
            ...
            valid_columns = [
                ...
                "Category",
                "Description",
                "Detailed / Combined Threat Scenarios",
                "Damage Scenarios",
                "Related Threats from Catalog",
                "Losses of Cybersecurity Properties",
                "Assets",
                "Related Attack Trees",
                "Related Attack Path Models",
                "Assessment References",
                "To be Assessed",
                "Assessment Jurification",
            ]
                ...
                if threat_record:
                    ...
                    for col in threat_columns:
                        if col == "SNo":
                            ...
                            threat_headers.append(
                                wrap_content(
                                    "Detailed / Combined Threat Scenarios", "white"
                                )
                            )
                        elif col == "Damage Scenarios":
                            threat_headers.append(
                                wrap_content("Damage Scenarios", "white")
                            )
                        elif col == "Related Threats from Catalog":
                            threat_headers.append(
                                wrap_content("Related Threats from Catalog", "white")
                            )
                        elif col == "Losses of Cybersecurity Properties":
                            threat_headers.append(
                                wrap_content(
                            ...
                            threat_headers.append(
                                wrap_content("Related Attack Trees", "white")
                            )
                        elif col == "Related Attack Path Models":
                            threat_headers.append(
                                wrap_content("Related Attack Path Models", "white")
                            )
                        elif col == "Assessment References":
                            threat_headers.append(
                                wrap_content("Assessment References", "white")
                            )
                        elif col == "To be Assessed":
                            threat_headers.append(
                                wrap_content("To be Assessed", "white")
                            )
                        elif col == "Assessment Jurification":
                            threat_headers.append(
                                wrap_content("Assessment Jurification", "white")
                            )
                        ...
                        for node_detail in detail_nodes:
                            ...
                            for props in node_props:
                                ...
                                damage_scenarios = "\n".join(
                                    [
                                        scene.get("Name", "")
                                        for scene in props.get("damage_scenes", [])
                                    ]
                                )
                                ...
                                for col in threat_columns:
                                    if col == "SNo":
                                        ...
                                        row.append(
                                            wrap_content(description, "black")
                                        )  # Description
                                    elif col == "Detailed / Combined Threat Scenarios":
                                        row.append(wrap_content(""))
                                    elif col == "Damage Scenarios":
                                        row.append(damage_scenarios)  # Damage Scenarios
                                    elif col == "Related Threats from Catalog":
                                        row.append(wrap_content(""))
                                    elif col == "Losses of Cybersecurity Properties":
                                        row.append(
                                            wrap_content(losses, "black")
                                        )  # Losses of Cybersecurity Properties
                                    elif col == "Assets":
                                        row.append(wrap_content(""))
                                    elif col == "Related Attack Trees":
            ...
            threat_scenario_data = [["No Threat Scenario Data Found"]]
        # =====================================================================================

        # ========================= Attack Tree Table =========================================
        if attack_trees_table == 1:
            attack_record = db.Attacks.find_one(
                ...
                if attack_record:
                    ...
                    for col in attack_columns:
                        if col == "SNo":
                            ...
                            attack_headers.append(
                                wrap_content("Knowledge of the Item", "white")
                            )
                        elif col == "Window of Opportunity":
                            attack_headers.append(
                                wrap_content("Window of Opportunity", "white")
                            )
                        elif col == "Equipment":
                            attack_headers.append(wrap_content("Equipment", "white"))
                        elif col == "Attack Feasibilities Rating":
                            attack_headers.append(
                                wrap_content("Attack Feasibilities Rating", "white")
                            )
                    ...
                    for index, scene in enumerate(scenes):
                        ...
                        for col in attack_columns:
                            if col == "SNo":
                                ...
                                row.append(
                                    wrap_content(scene.get("Name", ""), "black")
                                )  # Name
                            elif col == "Category":
                                ...
                                row.append(
                                    wrap_content(
                                        f"This is description for {scene.get('Name', '')}",
                                        "black",
                                    )
                                )  # Description
                            elif col == "Approach":
                                row.append(
                                    wrap_content(scene.get("Approach", ""), "black")
                                )  # Approach
                            elif col == "Elapsed Time":
                                row.append(
                                    wrap_content(scene.get("Elapsed Time", ""), "black")
                                )  # Elapsed Time
                            elif col == "Expertise":
                                row.append(
                                    wrap_content(scene.get("Expertise", ""), "black")
                                )  # Expertise
                            elif col == "Knowledge of the Item":
                                row.append(
                                    wrap_content(
                                        scene.get("Knowledge of the Item", ""), "black"
                                    )
                                )  # Knowledge of the Item
                            elif col == "Window of Opportunity":
                                row.append(
                                    wrap_content(
                                        scene.get("Window of Opportunity", ""), "black"
                                    )
                                )  # Window of Opportunity
                            elif col == "Equipment":
                                row.append(
                                    wrap_content(scene.get("Equipment", ""))
                                )  # Equipment
                            elif col == "Attack Feasibilities Rating":
                                row.append(
                                    wrap_content(
                                        scene.get("Attack Feasibilities Rating", "")
                                    )
                                )  # Attack Feasibilities Rating
        ...
        if risk_treatment == 1:
            ...
            valid_columns = [
                ...
                "Assets",
                "Damage Scenarios",
                "Related UNECE Threats or Vulns",
                "Safety Impact",
                "Financial Impact",
                "Operational Impact",
                "Privacy Impact",
                "Attack Tree or Attack Path(s)",
                "Attack Path Name",
                "Attack Path Details",
                "Attack Feasibility Rating",
                "Mitigated Attack Feasibility",
                "Acceptence Level",
                "Safety Risk",
                "Financial Risk",
                "Operational Risk",
            ...
            # Validate columns: filter out any invalid columns
            risk_treatment_columns = [
                col for col in risk_treatment_columns if col in valid_columns
            ]
            ...
            if not risk_treatment_columns:
                ...
                for col in risk_treatment_columns:
                    if col == "SNo":
                        ...
                        risk_trtmnt_headers.append(
                            wrap_content("Threat Scenario", "white")
                        )
                    elif col == "Assets":
                        ...
                        risk_trtmnt_headers.append(
                            wrap_content("Related UNECE Threats or Vulns", "white")
                        )
                    elif col == "Safety Impact":
                        risk_trtmnt_headers.append(
                            wrap_content("Safety Impact", "white")
                        ...
                        risk_trtmnt_headers.append(
                            wrap_content("Attack Tree or Attack Path(s)", "white")
                        )
                    elif col == "Attack Path Name":
                        risk_trtmnt_headers.append(
                            wrap_content("Attack Path Name", "white")
                        )
                    elif col == "Attack Path Details":
                        risk_trtmnt_headers.append(
                            wrap_content("Attack Path Details", "white")
                        )
                    elif col == "Attack Feasibility Rating":
                        risk_trtmnt_headers.append(
                            wrap_content("Attack Feasibility Rating", "white")
                        )
                    elif col == "Mitigated Attack Feasibility":
                        risk_trtmnt_headers.append(
                            wrap_content("Mitigated Attack Feasibility", "white")
                        )
                    elif col == "Acceptence Level":
                        risk_trtmnt_headers.append(
                            wrap_content("Acceptence Level", "white")
                        )
                    elif col == "Safety Risk":
                        risk_trtmnt_headers.append(wrap_content("Safety Risk", "white"))
                    elif col == "Financial Risk":
                        risk_trtmnt_headers.append(
                            wrap_content("Financial Risk", "white")
                        )
                    elif col == "Operational Risk":
                        risk_trtmnt_headers.append(
                            wrap_content("Operational Risk", "white")
                        )
                    elif col == "Privacy Risk":
                        risk_trtmnt_headers.append(
                            wrap_content("Privacy Risk", "white")
                        )
                    elif col == "Residual Safety Risk":
                        risk_trtmnt_headers.append(
                            wrap_content("Residual Safety Risk", "white")
                        )
                    elif col == "Residual Financial Risk":
                        risk_trtmnt_headers.append(
                            wrap_content("Residual Financial Risk", "white")
                        )
                    elif col == "Residual Operational Risk":
                        risk_trtmnt_headers.append(
                            wrap_content("Residual Operational Risk", "white")
                        )
                    elif col == "Residual Privacy Risk":
                        risk_trtmnt_headers.append(
                            wrap_content("Residual Privacy Risk", "white")
                        )
                    elif col == "Risk Treatment Options":
                        risk_trtmnt_headers.append(
                            wrap_content("Risk Treatment Options", "white")
                        )
                    elif col == "Risk Treatment Justification":
                        risk_trtmnt_headers.append(
                            wrap_content("Risk Treatment Justification", "white")
                        )
                    elif col == "Applied Measures":
                        risk_trtmnt_headers.append(
                            wrap_content("Applied Measures", "white")
                        )
                    elif col == "Detailed / Combined Threat Scenarios":
                        risk_trtmnt_headers.append(
                            wrap_content(
                        ...
                        risk_trtmnt_headers.append(
                            wrap_content("Cybersecurity Goals", "white")
                        )
                    elif col == "Contributing Requirements":
                        risk_trtmnt_headers.append(
                            wrap_content("Contributing Requirements", "white")
                        )
                    elif col == "CyberSecurity Claims":
                        risk_trtmnt_headers.append(
                            wrap_content("CyberSecurity Claims", "white")
                        )
                    ...
                    for index, rsk_tmt in enumerate(risk_treatment_record["Details"]):
                        ...
                        if cybersecurity and cybersecurity.get("cybersecurity_goals"):
                            for id in cybersecurity["cybersecurity_goals"]:
                                cybersecurity_goals_record = db.Cybersecurity.find_one(
                                    {
                                        "model_id": model_id,
                        ...
                        if cybersecurity and cybersecurity.get("cybersecurity_claims"):
                            for id in cybersecurity["cybersecurity_claims"]:
                                cybersecurity_claims_record = db.Cybersecurity.find_one(
                                    {
                                        "model_id": model_id,
                        ...
                        if cyberSecurity_record and threat_key:
                            contrRequNames = [
                                cyber_record["Name"]
                                for cyber_record in cyberSecurity_record["scenes"]
                                if cyber_record["threat_key"]
                                == rsk_tmt.get("threat_key")
                            ]

                        dmg_data = db.Damage_scenarios.find_one(
                            {"model_id": model_id, "Details._id": rsk_tmt["damage_id"]},
                            {"Details.$": 1},
                        )

                        if (
                            dmg_data
                            and "Details" in dmg_data
                            and len(dmg_data["Details"]) > 0
                        ):
                            ...
                            for col in risk_treatment_columns:
                                if col == "SNo":
                                    ...
                                    row.append(
                                        wrap_content(rsk_tmt.get("label", ""), "black")
                                    )
                                elif col == "Assets":
                                    row.append(
                                        wrap_content("")
                                    ...
                                    row.append(
                                        wrap_content(dmg.get("Name", ""), "black")
                                    )
                                elif col == "Related UNECE Threats or Vulns":
                                    row.append(
                                        wrap_content(
                                            ",".join(rsk_tmt.get("catalogs", "")),
                                            "black",
                                        )
                                    )
                                elif col == "Safety Impact":
                                    safety_impact = dmg["impacts"].get(
                                        "Safety Impact", ""
                                    )
                                    bg_color = getImpactBgcolour(safety_impact)
                                    row.append(
                                    ...
                                    financial_impact = dmg["impacts"].get(
                                        "Financial Impact", ""
                                    )
                                    bg_color = getImpactBgcolour(financial_impact)
                                    row.append(
                                        wrap_content(
                                            financial_impact, "black", bg_color
                                        )
                                    )  # Financial Impact
                                elif col == "Operational Impact":
                                    operational_impact = dmg["impacts"].get(
                                        "Operational Impact", ""
                                    )
                                    bg_color = getImpactBgcolour(operational_impact)
                                    row.append(
                                        wrap_content(
                                            operational_impact, "black", bg_color
                                        )
                                    )  # Operational Impact
                                elif col == "Privacy Impact":
                                    privacy_impact = dmg["impacts"].get(
                                        "Privacy Impact", ""
                                    )
                                    bg_color = getImpactBgcolour(privacy_impact)
                                    row.append(
                                    ...
                                    row.append(
                                        wrap_content(", ".join(contrRequNames), "black")
                                    )
                                elif col == "CyberSecurity Claims":
                            ...
                            risk_trtmnt_data.append(
                                ["No matching Damage Scenario found"]
                                * len(risk_trtmnt_headers)
                            )
                # else:
        ...
        page_size = (
            max(
                ...
                table_width_threat,
                table_width_attack,
                column_width_risk_trtmnt,
            )
            + 360,
            11 * 72,
        )  # Adjust width; height is letter size
        ...
        if image_stream:
            ...
            img = resize_image(
                image_stream, max_width=800, max_height=800
        ...
        if damage_scenarios_table == 1:
            if damage_record:
                ...
                elements.append(
                    Spacer(1, 12)
                )  # Add spacing (1 unit wide, 12 points tall)

                # Damage Scenario Table------------------
                damage_table = Table(
                    damage_scenario_data, colWidths=column_widths_damage, hAlign="LEFT"
                )
                ...
                elements.append(Spacer(1, 24))  # Spacer for more significant gap
        ...
        if threat_scenarios_table == 1:
            if threat_record:
                ...
                # Threat Scenario Table------------------
                threat_table = Table(
                    threat_scenario_data, colWidths=column_widths_threat, hAlign="LEFT"
                )
        ...
        if attack_trees_table == 1:
            if attack_record:
                ...
                # Attack Tree Table------------------
                attack_table = Table(
                    attack_tree_data, colWidths=column_widths_attack, hAlign="LEFT"
                )
        ...
        if risk_treatment == 1:
            if risk_treatment_record:
                ...
                # Risk Treatment Table------------------
                risk_trtmnt_table = Table(
                    risk_trtmnt_data, colWidths=column_widths_risk_trtmnt, hAlign="LEFT"
                )
                risk_trtmnt_table.setStyle(
                    TableStyle(
                        [
                            ("BACKGROUND", (0, 0), (-1, 0), colors.grey),
                            ("TEXTCOLOR", (0, 0), (-1, 0), colors.whitesmoke),
        ...
        blob_client = blob_service_client.get_blob_client(
            container=azure_container_name, blob=pdf_file_name + ".pdf"
        )
